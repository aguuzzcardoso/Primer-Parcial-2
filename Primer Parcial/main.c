...
int main()
{
    ...
    setJuego(arrayJuegos,2,3,"",30,3);
    setJuego(arrayJuegos,3,4,"",40,4);
    setJuego(arrayJuegos,4,5,"",50,5);
    ...
    setCliente(arrayClientes,0,1,"Jose","Espert",'m',"11-00005000");
    setCliente(arrayClientes,1,2,"Sergio","Espert",'m',"11-12345678");
    setCliente(arrayClientes,2,3,"Miguel","Espert",'m',"507-987654");
    setCliente(arrayClientes,3,4,"Daniel","Espert",'m',"11-00000000");
    setCliente(arrayClientes,4,5,"Mauricio","Espert",'m',"00000000");

    setAlquileres(arrayAlquileres,0,1,1,1,9,12,2018);
    setAlquileres(arrayAlquileres,1,2,2,2,9,12,2018);
    setAlquileres(arrayAlquileres,2,3,3,3,9,12,2018);
    setAlquileres(arrayAlquileres,3,4,4,4,9,12,2018);
    setAlquileres(arrayAlquileres,4,5,5,5,9,12,2018);
