...
void setCliente(eCliente arrayClientes[], int indice, int id, char nombre[], char apellido[], char sexo[], char telefono[])
{
    ...
    strcpy(arrayClientes[indice].sexo, sexo);
...
void setAlquileres(eAlquiler arrayAlquileres[], int indice, int id, int idJuego, int idCliente)
{
    ...
    /*
    arrayAlquileres[indice].dia = dia;
    arrayAlquileres[indice].mes = mes;
    arrayAlquileres[indice].ano = ano;
    */
...
void altaAlquiler (eAlquiler arrayAlquileres[], eJuego arrayJuegos[], eCategoria arrayCategorias[], eCliente arrayClientes[])
{
    ...
    else
    {
        ...
        nuevoAlquiler.codigoCliente = getValidInt("Ingrese el codigo del libro: ", "El codigo puede contener solamente numeros\n",1,MAX);
        ...
        {   nuevoAlquiler.codigoJuego ++;
            nuevoAlquiler.codigoJuego = getValidInt("Ingrese el codigo del cliente: ", "El codigo puede contener solamente numeros\n", 1, MAX);
            ...
            {
                /*
                nuevoAlquiler.dia = getValidInt("Ingrese el dia del prestamo: ", "El dia puede contener solamente numeros\n", 1, 31);
                nuevoAlquiler.mes = getValidInt("Ingrese el mes del prestamo: ", "El mes puede contener solamente numeros\n", 1, 12);
                nuevoAlquiler.ano = getValidInt("Ingrese el ano del prestamo: ", "El ano puede contener solamente numeros\n", 2000, 2019);
                */
